      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <img
              className="flex-shrink-0 object-cover mx-1 text-center rounded-full  w-10 h-11 mt-3"
              src={authData?.photoURL}
            />
            <div className="mx-1">
              <h1 className="text-sm font-semibold text-gray-700 dark:text-gray-200">Name: {authData?.displayName}</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400"> {authData?.email}</p>
            </div>
          </a> ) : (
               <a
               href="#"
          ...
          >
            ...
            <span className="mx-1"><Link to={"/profile"}>
            View Profile
            </Link> 
            </span>
          </a>
        ...
        {authData ? (
          ...
          <button
          className="w-full bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition-all duration-300 mt-4"
...
>
  ...
  <Link to={"/login"}>
    ...
    <button
    className="w-full bg-blue-900 text-white py-2 px-4 rounded-lg hover:bg-red-700 transition-all duration-300 mt-4"
